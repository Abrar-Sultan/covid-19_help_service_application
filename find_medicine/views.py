...
def find_med_home(request):
    """
    This method is used to display home page for this find medicine function.
    ...
    :return: this method returns a home page for find medicine
     which is a HTML page.


    :rtype: HttpResponse.
    """
    return render(request, 'find_med_home.html')
